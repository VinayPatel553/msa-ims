...
const API = 'http://localhost:8081/api/stocks'
...
export default function StockList () {
  ...
  const create = async () => {
    if (
      ...
      setError('Please enter valid numeric product ID, quantity, and location')
    ...
    try {
      ...
      setError(
        'Failed to add stock: ' + (err.response?.data?.message || err.message)
      )
    }
  }
